...
export function ToggleStatusDialog({
  ...
  const Icon = isActive ? Block : CheckCircleOutline;
    ...
    >
      ...
      <DialogContent sx={{ pt: 3, pb: 1, px: 3 }}>
        ...
        <Typography
          ...
          mb={0.5}
        >
          {isActive ? `Desactivar ${nameRecord}` : `Activar ${nameRecord}`}
        </Typography>
        ...
        >
          {isActive
            ? `El ${nameRecord} quedara inactivo de forma inmeditata.`
            : `El ${nameRecord} recuperará su actividad en el sistema de forma inmediata.`}
        </Typography>
